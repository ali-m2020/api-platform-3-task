 ...
 */
final class Version20230910072249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, car_id INT NOT NULL, star_rating SMALLINT NOT NULL, review_text TEXT DEFAULT NULL, PRIMARY KEY(id))');
